...
class ProcessMonitorWidget extends StatefulWidget {
  final List<dynamic> processes;

  const ProcessMonitorWidget({
    Key? key,
    required this.processes,
  }) : super(key: key);

  @override
  State<ProcessMonitorWidget> createState() => _ProcessMonitorWidgetState();
}

class _ProcessMonitorWidgetState extends State<ProcessMonitorWidget> {
  ...
  @override
  void didUpdateWidget(ProcessMonitorWidget oldWidget) {
  ...
  Widget build(BuildContext context) {
    final visibleProcesses = _showAllProcesses ? _sortedProcesses : _sortedProcesses.take(5).toList();
          ...
          if (_sortedProcesses.length > 5)
            Padding(
              ...
              child: OutlinedButton(
                ...
                child: Text(_showAllProcesses ? 'Show Less' : 'Show All Processes'),
              ),
            ),
        ],
      ),
