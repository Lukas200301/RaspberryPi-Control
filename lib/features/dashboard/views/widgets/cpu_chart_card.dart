...
/// CPU Chart Card - Real-time CPU usage graph
/// Glassmorphism design for v3.0
class CpuChartCard extends GetView<DashboardController> {
  const CpuChartCard({Key? key}) : super(key: key);
      ...
      return Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: _getCpuColor(controller.cpuUsage.value).withOpacity(0.2),
                    borderRadius: BorderRadius.circular(AppDimensions.radiusSM),
                    border: Border.all(
                      color: _getCpuColor(controller.cpuUsage.value),
                      width: 1,
                    ),
                  ),
                  child: Text(
                    _getCpuStatus(controller.cpuUsage.value),
                    style: TextStyle(
                      color: _getCpuColor(controller.cpuUsage.value),
                      fontWeight: FontWeight.bold,
                      fontSize: 11,
            ...
            SizedBox(
              height: 150,
              child: controller.cpuHistory.isEmpty
                  ? Center(
                      child: Text(
                        'Collecting data...',
                        style: TextStyle(
                            ...
                            belowBarData: BarAreaData(
                              ...
                              gradient: LinearGradient(
                                ...
                                colors: [
                                  ...
                                  AppColors.accentIndigo.withOpacity(0.0),
                                ],
                              ),
                            ),
                          ),
  ...
  Color _getCpuColor(double usage) {
    ...
    if (usage >= 70) return AppColors.warning;
